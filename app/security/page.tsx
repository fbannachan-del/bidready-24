...
export const metadata: Metadata = { title: "Security and data handling", description: "A precise account of BidReady 24 security controls, data processing, AI use and current limitations." };
  ...
  return (
    <div>
      ...
      <section className="border-y border-[var(--border)] bg-white px-5 py-20 sm:px-8"><div className="mx-auto grid max-w-[1120px] gap-14 lg:grid-cols-[.8fr_1.2fr]"><div><p className="eyebrow">Data flow</p><h2 className="section-title mt-4">Where your information goes</h2><p className="body-large mt-5">Processing depends on the features enabled for your project and the service configuration.</p></div><div className="divide-y divide-[var(--border)] border-y border-[var(--border)]">
        {[
          ["Application hosting", "Tender documents, extracted text, company evidence, analysis records and access data are processed and stored by the hosting environment used to operate BidReady 24."],
          ...
          ["Stripe", "Stripe hosts checkout and processes payment and billing information. BidReady 24 receives payment identifiers and signed webhook confirmation used to release a project."],
