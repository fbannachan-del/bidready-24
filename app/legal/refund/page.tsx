...
export default function RefundPolicy() {
  return <LegalNotice title="Refund policy">
    <p>BIDREADY24 is a one-off business service that begins consuming processing capacity after the tender pack is uploaded. This working policy explains how refund requests are assessed; statutory rights that apply cannot be excluded by it.</p>
    ...
    <h2>After processing starts</h2><p>Once files have been uploaded and substantive extraction or analysis has begun, work has been performed and a full refund is not normally available. BIDREADY24 may offer reprocessing, correction, partial refund or credit where that is a fair remedy for a service failure.</p>
    ...
    <h2>What is not a service failure</h2><p>A decision not to bid, an evidence gap, buyer rejection, low evaluation score or failure to win is not by itself evidence that the service was defective. BIDREADY24 does not sell or guarantee an outcome.</p>
