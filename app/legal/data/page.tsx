...
export default function DataHandling() {
  return <LegalNotice title="Data handling & retention">
    <p>This statement distinguishes the current operating position from the controls BIDREADY24 intends to add. It deliberately avoids promising an automatic deletion schedule that the deployed application does not yet enforce end to end.</p>
    ...
    <h2>Current retention position</h2><p>Source files, extracted content, structured findings, audit records, payment reconciliation data and support requests may remain stored while the service is operated and records are needed. Database deletion flags exist, but BIDREADY24 does not currently claim that all original files, extracted copies, backups and related records are automatically erased after a fixed number of days.</p>
