...
export default function AcceptableUse() {
  return <LegalNotice title="Acceptable use">
    <p>Use BidReady 24 only for lawful procurement work and material your organisation is entitled to process.</p>
    ...
    <h2>Enforcement</h2><p>BidReady 24 may suspend processing or revoke access where use creates a security, legal or integrity risk. A final enforcement and appeal process remains part of the outstanding legal-review work.</p>
  </LegalNotice>;
}
