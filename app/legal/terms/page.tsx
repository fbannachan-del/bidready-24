...
export default function Terms() {
  return <LegalNotice title="Service terms">
    ...
    <h2>6. No guarantees</h2><p>BidReady 24 does not certify eligibility or compliance and does not guarantee completeness, accuracy, a buyer score, successful portal submission, shortlisting, contract award or commercial result. Tender documents may be ambiguous, inconsistent, scanned poorly or changed by the buyer after analysis.</p>
